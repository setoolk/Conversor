...
public class Monedas {
    ...
    información de las tasas de cambio obtenidas a través de ConsultaConversion para realizar estas conversiones. */
        ...
        public Monedas(Conversion conversion) {
        ...
        public String obtenerMensajeRespuesta() {
            String mensaje = getMonedaBase().toUpperCase() + " " + getCantidad() + " equivale a: " + getMonedaObjetivo().toUpperCase() + " " + conversion.Conversion(getMonedaBase(), getMonedaObjetivo(), getCantidad());
